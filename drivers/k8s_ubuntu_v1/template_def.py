...
import magnum.conf
from magnum.drivers.heat import k8s_ubuntu_def as kftd

CONF = magnum.conf.CONF


class UBK8sTemplateDefinition(kftd.K8sFedoraTemplateDefinition):
    ...
    def get_params(self, context, cluster_template, cluster, **kwargs):
        extra_params = super(UBK8sTemplateDefinition,
